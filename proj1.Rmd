...
constructor_colours = c("Lewis Hamilton" = "#00D2BE", "Valtteri Bottas" = "#00D2BE",
...
ggplot(driver_tbl, aes(x = race_name, y = points)) +
  geom_line(
    aes(group = driver), 
    data = driver_tbl,
  ...
  labs(
    title = "F1 Driver's Championship Standings by Race",
    x = "Race",
    y = "Points",
    family = "kanit"
  )
